...
class Notice_Board_View_C extends CI_Controller {
  ...
  public function __construct() {
    ...
    $this->load->model('Notice_Board_View_M', 'FBM');
  }

  public function list() {
    // 페이지네이션
    $config['base_url'] = "/notice/list"; // 기본 URL 설정
    ...
    if($this->input->is_ajax_request()) {
      ...
      $this->layout->custom_view('board/notice_board_view_v', $data);
    }
  ...
  public function search() {
    ...
    // 페이지네이션
    $config['base_url'] = "/notice/list/search"; // 기본 URL 설정
