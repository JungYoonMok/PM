...
<div class="p-1 md:p-5 flex flex-col gap-0 text-gray-50">
  ...
  <div class="bg-[#2f2f2f] flex flex-col md:flex-row gap-0 border border-[#4f4f4f] rounded shadow-2xl min-h-[1000px]">
    ...
    <!-- 컨텐츠 -->
    <div class="p-5 w-full flex flex-col justify-between gap-10">
      
      <!-- 해당 게시판 최근 리스트 -->
      <div class="bg-[#2f2f2f] w-full p-1 rounded flex flex-col gap-5 overflow-x-auto shadow-inner">
        <table class="text-gray-50 text-center whitespace-nowrap">
          ...
          <? if (!empty($post_like)) { foreach($post_like as $li) : ?>
        ...
        <div class="<?= empty($post_like) ? 'inline-block' : 'hidden' ?> text-center">
          <p>데이터가 없습니다</p>
        </div>
